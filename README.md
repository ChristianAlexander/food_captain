...
> [!IMPORTANT]
> Check out the [`starter`](https://github.com/ChristianAlexander/food_captain/tree/starter) branch to follow along.
> Use [`starter-part-2`](https://github.com/ChristianAlexander/food_captain/tree/starter-part-2) if you are just here for Elixir!
