defmodule FoodCaptainWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: FoodCaptainWeb.Gettext
  ...
  @doc """
  Renders a [Heroicon](https://heroicons.com) or custom Food Captain icons.
  ...
  ## Examples
      ...
      <.icon name="captain-wheel" class="w-10 h-10" />
  """
  attr :name, :string, required: true
  attr :class, :any, default: "size-4"

  def icon(%{name: "captain-wheel"} = assigns) do
    ~H"""
    <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" style="fill-rule:evenodd;text-rendering:geometricPrecision;image-rendering:optimizeQuality;clip-rule:evenodd;shape-rendering:geometricPrecision" viewBox="0 0 8487 8487" class={@class} fill="currentColor">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FoodCaptainWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FoodCaptainWeb.Gettext, "errors", msg, opts)
    end
  end
