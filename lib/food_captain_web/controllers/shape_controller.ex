defmodule FoodCaptainWeb.ShapeController do
  ...
  #   sync_render(conn, params, Sessions.list_sessions_query(conn.assigns.current_scope))
  # end
  ...
  #   sync_render(conn, params, Sessions.get_session_my_votes_query(conn.assigns.current_scope, id))
  # end
end
