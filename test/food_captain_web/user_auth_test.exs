defmodule FoodCaptainWeb.UserAuthTest do
  use FoodCaptainWeb.ConnCase, async: true

  alias FoodCaptain.Accounts
  alias FoodCaptain.Accounts.Scope
  alias FoodCaptainWeb.UserAuth

  import FoodCaptain.AccountsFixtures

  @remember_me_cookie "_food_captain_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, FoodCaptainWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
